...
class LettersControllerTest < ActionController::TestCase
  ...
  test "should create letter" do
    assert_difference('Letter.count') do
      post :create, letter: { color: @letter.color, name: @letter.name, number: @letter.number, type: @letter.type }
    end
  ...
  test "should update letter" do
    patch :update, id: @letter, letter: { color: @letter.color, name: @letter.name, number: @letter.number, type: @letter.type }
    assert_redirected_to letter_path(assigns(:letter))
  end
